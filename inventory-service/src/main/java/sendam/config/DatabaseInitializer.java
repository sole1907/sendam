package sendam.config;

import sendam.address.Address;
import sendam.address.AddressRepository;
import sendam.catalog.Catalog;
import sendam.catalog.CatalogRepository;
import sendam.inventory.Inventory;
import sendam.inventory.InventoryRepository;
import sendam.inventory.InventoryStatus;
import sendam.product.Product;
import sendam.product.ProductRepository;
import sendam.shipment.Shipment;
import sendam.shipment.ShipmentRepository;
import sendam.shipment.ShipmentStatus;
import sendam.warehouse.Warehouse;
import sendam.warehouse.WarehouseRepository;
